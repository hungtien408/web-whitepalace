<%@ Page Title="" Language="C#" MasterPageFile="~/en/site.master" AutoEventWireup="true"
    CodeFile="dich-vu-cn.aspx.cs" Inherits="dich_vu" %>

<%@ Register Src="~/en/uc/banner-sub.ascx" TagName="bannersub" TagPrefix="uc2" %>
        ...
        <div id="isotopelist" class="row ser-wrapper">
            <asp:ListView ID="lstService" runat="server" DataSourceID="odsService" EnableModelValidation="True">
                <ItemTemplate>
                    <div class="col-sm-4 col-xs-6 element-item">
                        <div class="box-ser">
                            <a href='<%# progressTitle(Eval("ProductNameEn")) + "-cni-" + Eval("CategoryID") + "-pi-" + Eval("ProductID") + ".aspx" %>' class='<%# "ser-img cl-" + (Container.DataItemIndex + 1).ToString() %>'>
                            ...
                            <h3 class="ser-name text-uppercase">
                                <a href='<%# progressTitle(Eval("ProductNameEn")) + "-cni-" + Eval("CategoryID") + "-pi-" + Eval("ProductID") + ".aspx" %>'><%# Eval("ProductNameEn") %></a></h3>
                        </div>
                    </div>
                </ItemTemplate>
                <LayoutTemplate>
            ...
            <asp:ObjectDataSource ID="odsService" runat="server" SelectMethod="ProductSelectAll"
                ...
                <SelectParameters>
                    ...
                    <asp:QueryStringParameter QueryStringField="cni" Name="CategoryID" Type="String" />

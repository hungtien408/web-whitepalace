<%@ Page Title="" Language="C#" MasterPageFile="~/en/site.master" AutoEventWireup="true" CodeFile="dich-vu-csvc.aspx.cs" Inherits="dich_vu_csvc" %>
                            ...
                            <asp:ListView ID="lstImageCSVC" runat="server" DataSourceID="odsImageCSVC" EnableModelValidation="True">
                                <ItemTemplate>
                                    <div class="col-md-4 element-item">
                                        <div class="tab-pic">
                                            <div class="pic-img">
                                                <a class="fancybox fancybox.iframe" href='<%# progressTitle(Eval("PhotoAlbumCategoryNameEn")) + "-gl-" + Eval("PhotoAlbumCategoryID") + ".aspx" %>'>
                                            ...
                                            <div class="pic-name">
                                                <%# Eval("PhotoAlbumCategoryNameEn")%></div>
                                        </div>
                                    </div>
                                </ItemTemplate>
                                <LayoutTemplate>

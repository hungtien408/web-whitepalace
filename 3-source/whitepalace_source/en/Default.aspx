...
<asp:Content ID="Content2" ContentPlaceHolderID="bannerdefault" runat="Server">
    ...
    <asp:ObjectDataSource ID="odsPopupTop" runat="server" SelectMethod="AdsBannerSelectAll"
                ...
                <div id='<%# "htmlcaption" + Eval("AdsBannerID") %>' class="nivo-html-caption">
                    <div class="banner-text">
                        ...
                        <div class="text-name">
                            <%# Eval("TitleEn2") %></div>
                        <div class="book">
                            <a href='<%# Eval("Website") %>'>Details</a></div>
                    </div>
                </div>
            </ItemTemplate>
            <LayoutTemplate>
                                ...
                                <asp:ListView ID="lstAboutSub" runat="server" DataSourceID="odsAboutSub" EnableModelValidation="True">
                                    <ItemTemplate>
                                        <div class="col-md-6 zoom">
                                            <div class="about-box">
                                                <div class="tb-img">
                                                    <a href='<%# progressTitle(Eval("ProductNameEn")) + "-gt-" + Eval("ProductID") + ".aspx" %>'>

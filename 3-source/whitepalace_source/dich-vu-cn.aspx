            ...
            <asp:ListView ID="lstService" runat="server" DataSourceID="odsService" EnableModelValidation="True">
                <ItemTemplate>
                    <div class="col-sm-4 col-xs-6 element-item">
                        <div class="box-ser">
                            <a href='<%# progressTitle(Eval("ProductName")) + "-cni-" + Eval("CategoryID") + "-pi-" + Eval("ProductID") + ".aspx" %>' class='<%# "ser-img cl-" + (Container.DataItemIndex + 1).ToString() %>'>
                            ...
                            <h3 class="ser-name text-uppercase">
                                <a href='<%# progressTitle(Eval("ProductName")) + "-cni-" + Eval("CategoryID") + "-pi-" + Eval("ProductID") + ".aspx" %>'><%# Eval("ProductName") %></a></h3>
                        </div>
                    </div>
                </ItemTemplate>
                <LayoutTemplate>

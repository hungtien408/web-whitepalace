        ...
        <asp:Panel ID="pnlSearch" DefaultButton="btnSearch" runat="server">
            ...
            <table class="search">
                <tr>
                    ...
                    <td>
                        <asp:RadTextBox ID="txtSearchProductName" runat="server" Width="130px" EmptyMessage="Tiêu đề...">
                        </asp:RadTextBox>
                    </td>
                                                ...
                                                <table class="search">
                                                    <tr>
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 360px x 300px)</span><br/>
                                                            <%--<span class="required">(Kích thước bí quyết khoẻ & đẹp 360px x 150px)</span>--%>

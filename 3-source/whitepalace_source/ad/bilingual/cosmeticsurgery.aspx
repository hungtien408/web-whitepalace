<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="cosmeticsurgery.aspx.cs" Inherits="ad_single_product" %>
        ...
        <asp:RadGrid ID="RadGrid1" AllowMultiRowSelection="True" runat="server" Culture="vi-VN"
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn DataField="InStock" HeaderText="Xem trên menu" SortExpression="InStock">
                        <ItemTemplate>
                                                ...
                                                <table class="search">
                                                    <tr>
                                                        ...
                                                        <td runat="server">
                                                            ...
                                                            <span class="required">(Kích thước 387px x 300px)</span>
                                                    ...
                                                    <tr>
                                                        <td class="left" colspan="2">
                                                            ...
                                                            &nbsp;&nbsp;
                                                            <asp:CheckBox ID="chkInStock" runat="server" CssClass="checkbox" Text=" Xem trên menu"
                                        ...
                                        <div class="sub_box">
                                            ...
                                            <div class="cont">
                                                <asp:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                                    ...
                                                    <span class="required">(Kích thước 315px x 215px)</span>

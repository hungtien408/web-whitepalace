<%@ Page Title="" Language="C#" MasterPageFile="~/ad/template/adminEn.master" AutoEventWireup="true"
    CodeFile="cosmeticsurgerycategory.aspx.cs" Inherits="ad_single_productcategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
    <h3 class="mainTitle">
        ...
        Danh Mục Phẩu Thuật Thẩm Mỹ</h3>
    <br />
            ...
            <MasterTableView CommandItemDisplay="TopAndBottom" DataSourceID="ObjectDataSource1"
                ...
                <Columns>
                    ...
                    <asp:GridTemplateColumn HeaderText="Ảnh Menu">
                        <ItemTemplate>
                            <asp:Panel ID="Panel2" runat="server" Visible='<%# string.IsNullOrEmpty( Eval("ImageNameMenu").ToString()) ? false : true %>'>
                                            ...
                                            <table class="search">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="required">(Kích thước 1366px x 500px)</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="left" valign="top">
                                                    ...
                                                    <td>
                                                        <asp:HiddenField ID="hdnImageNameMenu" runat="server" Value='<%# Eval("ImageNameMenu") %>' />
                                                        <asp:RadUpload ID="FileImageNameMenu" runat="server" AllowedFileExtensions=".jpg,.jpeg,.gif,.png"
                                                            ControlObjectsVisibility="None" Culture="vi-VN" InputSize="69" Language="vi-VN" />
                                            ...
                                            <div class="cont">
                                                <asp:RadAjaxPanel ID="RadAjaxPanel2" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                                    <asp:RadAsyncUpload ID="FileImageAlbum" runat="server" MultipleFileSelection="Automatic"
                                                        TargetFolder="~/res/productcategory/album/" TemporaryFolder="~/res/TempAsync"
                                                        Width="100%" AllowedFileExtensions="jpg,jpeg,gif,png" Localization-Select="Chọn"
                                                        Localization-Cancel="Hủy" Localization-Remove="Xóa" OnFileUploaded="FileImageAlbum_FileUploaded">
                                                    </asp:RadAsyncUpload>
                                                    <span class="required">(Kích thước 215px x 215px)</span>
                                                    ...
                                                    <asp:RadAjaxPanel ID="RadAjaxPanel3" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                                                        <asp:RadListView runat="server" ID="RadListView1" DataSourceID="OdsProductCategoryPhotoAlbum"
                                                            DataKeyNames="ProductImageCategoryID" OverrideDataSourceControlSorting="True"
                                                            OnItemCommand="RadListView1_ItemCommand" PageSize="100" Width="100%" Visible='<%# (Container is GridEditFormInsertItem) ? false : true %>'
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <fieldset style="float: left; margin: 5px; padding: 2px 2px 2px 2px; position: relative;
                                                                    ...
                                                                    <a id="A1" href='<%# "~/res/productcategory/album/" + Eval("ImageName") %>' runat="server"
                                                                        class="lightbox">
                                                                        <img id="Img1" alt="" src='<%# "~/res/productcategory/album/thumbs/" + Eval("ImageName") %>'
                                                            ...
                                                            <EditItemTemplate>
                                                                <asp:HiddenField ID="hdnProductImageCategoryID" runat="server" Value='<%# Eval("ProductImageCategoryID") %>' />
                                                                <asp:HiddenField ID="hdnImageName" runat="server" Value='<%# Eval("ImageName") %>' />
                                                                <asp:Panel ID="Panel2" runat="server" DefaultButton="lnkUpdate">
                                                                    ...
                                                                    <table width="100%">
                                                                        <tr>
                                                                            ...
                                                                            <td valign="top">
                                                                                <img id="Img2" alt="" src='<%# "~/res/productcategory/album/thumbs/" + Eval("ImageName") %>'
                                                        ...
                                                        <asp:ObjectDataSource ID="OdsProductCategoryPhotoAlbum" runat="server" DeleteMethod="ProductImageCategoryDelete"
                                                            SelectMethod="ProductImageCategorySelectAll" TypeName="TLLib.ProductImageCategory"
                                                            UpdateMethod="ProductImageCategoryUpdate">
                                                            <DeleteParameters>
                                                                <asp:Parameter Name="ProductImageCategoryID" Type="String" />
                                                            </DeleteParameters>
                                                            <SelectParameters>
                                                                <asp:ControlParameter Name="ProductCategoryID" ControlID="hdnProductCategoryID" PropertyName="Value"
                                                                    Type="String" />
                                                        ...
                                                        <asp:RadListView runat="server" ID="RadListView2" PageSize="100" Width="100%" Visible='<%# (Container is GridEditFormInsertItem) ? true : false %>'
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <fieldset style="float: left; margin: 5px; padding: 2px 2px 2px 2px; position: relative;
                                                                    background: #eeeeee;" class="myClass">
                                                                    <a id="A2" href='<%# "~/res/productcategory/album/" + Eval("ImageName") %>' runat="server"
                                                                        class="lightbox">
                                                                        <img id="Img1" alt="" src='<%# "~/res/productcategory/album/thumbs/" + Eval("ImageName") %>'
                                                                            runat="server" width="100" height="100" />
                                                                    </a>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="ProductCategoryDelete"
        SelectMethod="ProductCategorySelectAll" TypeName="TLLib.ProductCategory" UpdateMethod="ProductCategoryUpdate2"
        InsertMethod="ProductCategoryInsert2">
        <DeleteParameters>
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="ImageName" Type="String" />
            <asp:Parameter Name="ImageNameMenu" Type="String" />

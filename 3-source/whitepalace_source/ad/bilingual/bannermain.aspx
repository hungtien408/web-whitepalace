...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="Server">
                            ...
                            <table class="search">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="required">(Kích thước 1366px x 450px)</span>
                                    </td>
                                </tr>
                                <tr class="invisible">
                                    <td class="left">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTitleEn1" runat="server" Text='<%# Bind("TitleEn1") %>'
                                            Width="500px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtTitleEn2" runat="server" Text='<%# Bind("TitleEn2") %>'
                                            Width="500px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr class="invisible">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="AdsBannerDelete"
        SelectMethod="AdsBannerSelectAll" TypeName="TLLib.AdsBanner" UpdateMethod="AdsBannerUpdate2">
        <DeleteParameters>
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="TitleEn1" Type="String" />
            <asp:Parameter Name="Title2" Type="String" />
            <asp:Parameter Name="TitleEn2" Type="String" />

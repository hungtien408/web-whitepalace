...
public partial class ad_single_advertisement : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemCommand(object sender, GridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "PerformInsert" || e.CommandName == "Update")
        {
            ...
            string strTitleEn1 = ((TextBox)row.FindControl("txtTitleEn1")).Text.Trim();
            string strTitle2 = ((TextBox)row.FindControl("txtTitle2")).Text.Trim();
            string strTitleEn2 = ((TextBox)row.FindControl("txtTitleEn2")).Text.Trim();
            ...
            {
                strFileName = oAdsBanner.AdsBannerInsert2(
                    strFileName,
